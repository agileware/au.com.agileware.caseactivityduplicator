...
function _caseactivityduplicator_civix_mixin_polyfill() {
...
function _caseactivityduplicator_civix_civicrm_config($config = NULL) {
  ...
  _caseactivityduplicator_civix_mixin_polyfill();
}
 ...
 */
function _caseactivityduplicator_civix_civicrm_enable(): void {
  _caseactivityduplicator_civix_civicrm_config();
  _caseactivityduplicator_civix_mixin_polyfill();
}
  ...
  if (empty($path)) {
    ...
    foreach ($menu as $key => &$entry) {
      if ($entry['attributes']['name'] == $first) {
        ...
        $found = _caseactivityduplicator_civix_insert_navigation_menu($entry['child'], implode('/', $path), $item);
      }
    }
    return $found;
  }
